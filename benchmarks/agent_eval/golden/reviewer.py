...
class GoldenDatasetReviewer:
    ...
    def _save_progress(self) -> None:
        ...
        progress_path = Path(f"benchmarks/agent_eval/golden/datasets/{self.dataset.name}_review.json")
...
def run_review_cli(dataset_path: str, reviewer_name: str = "anonymous"):
    ...
    while True:
        ...
        if choice == "1":
            ...
            export_path = Path(f"benchmarks/agent_eval/golden/datasets/{dataset.name}_approved.json")
