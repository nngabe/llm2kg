...
def parse_args():
    parser = argparse.ArgumentParser(description="Fine-tune models using Q-GaLore")
    parser.add_argument("--model", type=str, default="google/gemma-3-12b-it", help="HuggingFace model ID")
    parser.add_argument("--data_dir", type=str, default="data/finetuning", help="Training data directory")
    parser.add_argument("--output_dir", type=str, default="models/finetuned/qgalore", help="Output directory")
    parser.add_argument("--galore_rank", type=int, default=128, help="GaLore projection rank")
    parser.add_argument("--update_proj_gap", type=int, default=200, help="Steps between projection updates")
    parser.add_argument("--galore_scale", type=float, default=0.25, help="GaLore gradient scale")
    ...
    parser.add_argument("--upload_hf", action="store_true", help="Upload model to HuggingFace Hub")
...
def main():
    ...
    logger.info(f"GaLore rank: {args.galore_rank}, scale: {args.galore_scale}, proj_gap: {args.update_proj_gap}")
